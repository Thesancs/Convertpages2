  ...
  return (
    <section className="py-16 md:py-24 bg-secondary/50">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <AnimateOnScroll animationClassName="animate-in fade-in duration-500" delay={200} className="flex flex-wrap justify-center gap-4">
         ...
         <AnimateOnScroll animationClassName="animate-in fade-in duration-500" delay={400} className="text-center mt-16">
          <CtaButton />
        </AnimateOnScroll>
      </div>
    </section>
